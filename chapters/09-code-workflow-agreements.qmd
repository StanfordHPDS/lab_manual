...
**Option 1: [ruff](https://docs.astral.sh/ruff/)**

[Ruff](https://docs.astral.sh/ruff/) uses the [Black style guide](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html) is more performant and extensible. 
...
**Option 2: [black](https://black.readthedocs.io)**

Black uses the [Black style guide](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html). 
...
**Option 3: [rye](https://rye-up.com/)**

[Rye](https://rye-up.com/) is a global Python manager. It uses the [Ruff](https://docs.astral.sh/ruff/) to format Python code using the [Black style guide](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html). 

Rye is not installable via pip; follow the [instructions on the website](https://rye-up.com/) to install it.
...
RStudio supports the idea of *RStudio Projects*. These are handy setups because they set your working directory wherever your project is on your computer. See See [Project-Oriented Workflows](https://www.tidyverse.org/blog/2017/12/workflow-vs-script/) for more.
...
**Option 1: [venv](https://docs.python.org/3/library/venv.html) + [pip](https://pip.pypa.io/en/stable/)**
...
**Option 2: [conda](https://docs.conda.io/en/latest/)**
...
**Option 1: [pyenv](https://github.com/pyenv/pyenv)**
...
See the [Conda documentation](https://conda.io/projects/conda/en/latest/user-guide/tasks/manage-python.html) for other ways of interacting with the Python version.
...
## Python
Docker doesn't require a different approach for Python, but some Python-specific tools will save time. Here's a tutorial on setting up and using Docker with Python in VS Code: 
