...
- [ ] Follow Data Use Agreement requirements regarding project review from a third party prior to submission. Currently, all manuscripts using PHS data must be emailed to support@stanfordphs.freshdesk.com for review before posted as a preprint or submission to a conference/journal.
...
- [ ] Check that the appropriate funding sources have been acknowledged in the publication. Ask Dr. Rose to confirm this section is correct.
