...
## Respect for the People Represented in Study Data {#sec-respect-people-data}
...
## Trainee Mentorship and Support {#sec-support}

Dr. Rose's mentorship of trainees involves support through 1:1 meetings (see @sec-meetings) as well as Lab group activities. We hold Lab Meetings approximately weekly to increase visibility across Lab projects, brainstorm ideas, and discuss research-related topics. The Lab also offers several internal opportunities for skill building and professional growth, including data jamborees, [trainings](https://github.com/StanfordHPDS/training), [book clubs](https://github.com/StanfordHPDS/hpds_book_club), and journal clubs. 

While most trainees joining the Lab has some prior experience in programming (typically R or Python), we do not have any expectations that new trainees are expert coders or have any previous experience in the coding and reproducibility workflows described in this Lab manual. Trainees develop these skills throughout their time in the Lab with substantial support via our data jamboree and training activities, as well as individual support from Lab research software engineer Malcolm Barrett.

## Trainee Resources, Access, and Accomodations
