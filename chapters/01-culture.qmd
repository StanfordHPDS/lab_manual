...
While most trainees joining the Lab have some prior experience in programming (typically R or Python), we do not have any expectations that new trainees are expert coders or have previous experience in the coding and reproducibility workflows described in this Lab manual. Trainees develop these skills throughout their time in the Lab with substantial support via our data jamboree and training activities, as well as individual support from Lab research software engineer Malcolm Barrett.
