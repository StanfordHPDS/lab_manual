...
The first step for new Lab members is to send Dr. Rose your GitHub username to be added to the Lab’s GitHub organization account. Then, review our [internal onboarding documentation](https://github.com/StanfordHPDS/onboarding) for new Lab members.

*Rotation students do not need to complete all of these steps.*
...
We document meetings with agendas (see @sec-meeting-agendas) and manage projects with Git and GitHub (see @sec-git-github). Trainees create a GitHub repository for each project in our [Lab GitHub organization](https://github.com/StanfordHPDS) with naming following conventions described in @sec-naming. The first step in the project repository is often to begin writing a [research plan](https://github.com/StanfordHPDS/research_plans/). We prefer reproducible documents using Quarto (see @sec-quarto) for our projects.
...
Push a commit to the project's GitHub repository at the same time you update your agenda document, even if you plan to make further changes prior to the meeting. If additional changes are made to the repository ahead of the meeting, push a second commit. 
...
The Lab offers several internal opportunities for professional growth, including data jamborees, [trainings](https://github.com/StanfordHPDS/training), [book clubs](https://github.com/StanfordHPDS/hpds_book_club), and journal clubs. We also host informal lunches and coffee chats. If you have ideas for events, suggestions are always welcome.
...
Job candidates should request access to the Lab [job tracking template](docs.google.com/spreadsheets/d/1EB3ozh96kzLu2QrHafjwadsYlWjmF0NX6iM8BjLwzE4), make a copy, fill in details specific to your search, and invite Dr. Rose to the document. 
