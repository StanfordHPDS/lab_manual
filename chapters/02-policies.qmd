...
The first step for new Lab members is to send Dr. Rose your GitHub username to be added to the Lab’s GitHub organization account. Then, review our [internal onboarding documentation](https://github.com/StanfordHPDS/onboarding) for new Lab members. Please also see @sec-support for a summary of trainee support systems for your development as a scientist in the Lab.
...
## Recurring Meetings {#sec-meetings}
...
Once a project's GitHub repository has been created, push a commit at the same time you update your agenda document each week, even if you plan to make further changes prior to the meeting. If additional changes are made to the repository ahead of the meeting, push a second commit. 
